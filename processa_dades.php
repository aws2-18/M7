...
<form action="processa_dades.php" method="post" id="myform" name="myform">
    ...
    <input type="checkbox" checked="checked" name="mycheckbox[]" value="2" /> Second checkbox<br /><br /> <!-- Cuando tiene corchete puedes seleccionar mas de una opcion
-->
...
print_r($_REQUEST);
echo('<br><br>');
echo('El valor de text es '.$_REQUEST['mytext']);
echo('<br><br>');
echo('El valor del radio es '.$_REQUEST['myradio']);
echo('<br><br>');
echo('El valor del checkbox es'.$_REQUEST['mycheckbox']);
echo('<br><br>');
echo('El valor del select es '.$_REQUEST['myselect']);
echo('<br><br>');
echo('EL valor del text area es'.$_REQUEST['mytextarea']);
